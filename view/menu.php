        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <a href="" class="brand-link">
                    ...
                    <span class="brand-text font-weight-light">Desarrolo web</span>
                </a>
                <div class="sidebar">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr v-for="(comentario,indice) of ctComentarios">
                                                <td class="text-center">{{comentario.intId_Imagen}}</td>
                                                <td class="text-center"><img :src="'../src/img/'+comentario.vchImagen" class="rounded" width="50px" height="50px"></td>
                                                <td class="text-center">{{comentario.vchNombre}}</td>
                                                <td class="text-center">{{comentario.vchComentario}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
